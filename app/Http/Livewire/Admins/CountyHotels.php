...
class CountyHotels extends Component
{
    use WithPagination;
    use WithFileUploads;
    public $name;
    ...
    {
        $data = $this->validate();
        $hotel = $this->county->hotels()->create($data);
    ...
    public function updateModal($id)
    {
        ...
        // $this->currentphotos = $county->images()->pluck('file_name');
    }
    ...
    {
        $countyHotels = $this->county->hotels()->paginate(5);
        return view('livewire.admins.county-hotels', [
            'countyHotels' => $countyHotels
        ]);
    }
}