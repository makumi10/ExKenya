...
class CountyRestaurants extends Component
{
    public $county;
    public $name;
    public $longtiude;
    ...
    {
        $data = $this->validate();
        $restaurant = $this->county->restaurants()->create($data);
    ...
    {
        $countyRestuarants = $this->county->restaurants()->paginate(5);
        return view('livewire.admins.county-restaurants', ['countyRestuarants' => $countyRestuarants]);
    }
}