<div>
    <div class="bg-white px-3 py-4 rounded text-black w-full">
        <div class="">
            <h1 class="mb-8 text-base sm:text-3xl">Add a new county</h1>
            <div>

                <input type="text" class="block border border-grey-light p-3 rounded mb-4 w-full md:w-1/2" name="name"
                    placeholder="county name" wire:model.lazy="name" />
                @error('name')
            ...
            <div class="inline-block relative w-full md:w-1/2 mb-4">
                <select
                    ...
                    <option value="North Eastern">North Eastern Region</option>
                </select>
                @error('region')
                    <span class="text-sm text-red-600 tracking-wide">{{ $message }}</span>
                @enderror
            ...
            @if (!$updating)
                ...
                <div class="mb-4" wire:model.debounce.1000ms="details" wire:ignore>
                    ...
                    <trix-editor input="details" class="trix-content"
                        placeholder="county details, this will be used in the users view of the county"></trix-editor>
                </div>
            @elseif($updating)
            ...
            @if (!$updating)
                <div class="mb-4" wire:model.debounce.1000ms="weather" wire:ignore>
                    ...
                    <trix-editor input="weather" class="trix-content"
                        placeholder="county weather, this will be used in the users view of the county"></trix-editor>
                </div>
            @elseif($updating)
                <div class="mb-4" wire:ignore>
                    <input id="weather" type="hidden" name="weather">
            ...
            <div class="inline-block relative w-full mb-4 h-12">
                <select
                    ...
                    <option selected>County is famous for</option>
                  ...
                  <div class='flex items-center justify-center w-full'>
                      <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-200 hover:border-purple-300 group'>
                          <div class='flex flex-col items-center justify-center pt-7'>
                            ...
                            <p class='lowercase text-sm text-gray-400 group-hover:text-white pt-1 tracking-wider'>Select some photos for the county</p>
                          </div>
