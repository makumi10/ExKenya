            ...
            @if (!$updating)
                ...
                <div class="mb-4" wire:model.debounce.1000ms="details" wire:ignore>
                    ...
                    <trix-editor input="details" class="trix-content"
                        placeholder="Hotel details, this will be used in the users view of the hotel"></trix-editor>
                </div>
            @elseif($updating)
                  ...
                  <div class='flex items-center justify-center w-full'>
                      <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-200 hover:border-purple-300 group'>
                          <div class='flex flex-col items-center justify-center pt-7'>
                            ...
                            <p class='lowercase text-sm text-gray-400 group-hover:text-white pt-1 tracking-wider'>Select some photos for the Hotel</p>
                          </div>
