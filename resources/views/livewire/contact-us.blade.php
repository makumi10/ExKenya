  <div class=" flex justify-center items-center  w-full relative min-h-screen mt-8 lg:mt-0  overflow-hidden mb-8 lg:mb-0"
      ...
      <div class=" w-10/12 h-full bg-white   rounded-xl z-50  grid grid-cols-1 md:grid-cols-2 overflow-hidden ">
          <div class="contact-info py-9 px-8 relative ">
              ...
              <p class="text text-xl text-gray-600"> You can Reach us via the following platforms.</p>
              <div class="info">
              ...
              <div class="socials pt-8">
                  ...
                  <div class="social-icons flex mt-2 ">
                      ...
                      <a href=""
                          class=" w-9 h-9 rounded-full border-2 border-blue-400  text-center text-gray-600  mr-6 leading-8 hover:text-white hover:bg-gray-600 duration-300 ease-in-out ">
