    ...
    <section class=" w-full grid grid-cols-1 gap-8 lg:grid-cols-3 p-4 md:p-12 md:pb-0 ">
        ...
        <div class="lg:col-span-2">
            ...
            <div class=" bg-white p-4 lg:p-12 shadow-lg rounded-xl w-auto  mb-8" style="min-height: 580px">
                ...
                <p class=" text-justify text-xl font-semibold tracking-wide">{!! $details !!}</p>
            </div>
            @if ($type === 'county')
                @livewire('county-feature', ['CountyId' => $object->id , 'type'=>'cities' ])
                @livewire('county-feature', ['CountyId' => $object->id , 'type'=>'hotels' ])
                @livewire('county-feature', ['CountyId' => $object->id , 'type'=>'restaurants' ])
                @livewire('county-feature', ['CountyId' => $object->id , 'type'=>'points of interest' ])
